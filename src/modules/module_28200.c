...
static const char *SIGNATURE_METAMASK_WALLET = "$1password$";
...
int module_hash_decode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED void *digest_buf, MAYBE_UNUSED salt_t *salt, MAYBE_UNUSED void *esalt_buf, MAYBE_UNUSED void *hook_salt_buf, MAYBE_UNUSED hashinfo_t *hash_info, const char *line_buf, MAYBE_UNUSED const int line_len)
{
  ...
  metamask->salt_buf_pc[0] = byte_swap_32 (salt->salt_buf_pc[0]);
  metamask->salt_buf_pc[1] = byte_swap_32 (salt->salt_buf_pc[1]);
  metamask->salt_buf_pc[2] = byte_swap_32 (salt->salt_buf_pc[2]);
  metamask->salt_buf_pc[3] = byte_swap_32 (salt->salt_buf_pc[3]);
  metamask->salt_buf_pc[4] = byte_swap_32 (salt->salt_buf_pc[4]);
  metamask->salt_buf_pc[5] = byte_swap_32 (salt->salt_buf_pc[5]);
  metamask->salt_buf_pc[6] = byte_swap_32 (salt->salt_buf_pc[6]);
  metamask->salt_buf_pc[7] = byte_swap_32 (salt->salt_buf_pc[7]);
